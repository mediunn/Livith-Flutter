...
- Any change touching **2 or more layers (Model/View/ViewModel)**, **domain models**, **API contracts**, or **multiple files** REQUIRES a plan document.
...
- Model, ViewModel(Notifier/AsyncNotifier), Service, Repository, mappers, state-changing logic → **TDD applies**.
...
3. Is this Model/ViewModel/Service logic? If yes → write the failing test FIRST.
